...
/mob/living/carbon/human/attack_hand(mob/living/user)
	if(user)
		if(user.combat_mode)
			...
			for(var/mob/living/carbon/human/npc/N in puppets)
...
/mob/living/carbon/human/bullet_act(obj/projectile/P)
	...
	if(P)
		if(P.firer)
			...
			for(var/mob/living/carbon/human/npc/N in puppets)
				N.add_presence_enemies(P.firer)
...
/mob/living/carbon/human/hitby(atom/movable/AM, skipcatch, hitpush = TRUE, blocked = FALSE, datum/thrownthing/throwingdatum)
	...
	if(throwingdatum)
		if(throwingdatum.thrower)
			...
			for(var/mob/living/carbon/human/npc/N in puppets)
				N.add_presence_enemies(throwingdatum.thrower)
...
/mob/living/simple_animal/hostile/beastmaster/bullet_act(obj/projectile/P)
	. = ..()
	if(P)
		if(P.firer)
			for(var/mob/living/simple_animal/hostile/beastmaster/B in beastmaster.beastmaster)
