...
/datum/action/discipline/IsAvailable(feedback = FALSE)
...
/datum/action/discipline/update_button_name(atom/movable/screen/movable/action_button/button, force)
	if(discipline)
		name = discipline.current_power.name
		desc = discipline.current_power.desc
	return ..()

/datum/action/discipline/apply_button_icon(atom/movable/screen/movable/action_button/current_button, force)
	current_button.cut_overlays(TRUE)
	if(discipline)
		current_button.add_overlay(mutable_appearance(button_icon, "[discipline.icon_state]"))
		current_button.icon_state = "[discipline.icon_state]"
...
/datum/action/discipline/proc/begin_targeting()
	...
	client.mouse_pointer_icon = 'wod13/modules/vtmb/icons/effects/mouse_pointers/discipline.dmi'
