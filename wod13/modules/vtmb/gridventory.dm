...
/datum/storage/concrete/vtm
	grid = TRUE
	max_w_class = WEIGHT_CLASS_BULKY
	max_combined_w_class = 1000
	max_items = 1000

/datum/storage/concrete/vtm/satchel
	screen_max_columns = 6
	screen_max_rows = 6

/datum/storage/concrete/vtm/backpack
	screen_max_columns = 6
	screen_max_rows = 7

/datum/storage/concrete/vtm/duffel
	screen_max_columns = 8
	screen_max_rows = 6

/datum/storage/concrete/vtm/firstaid
	screen_max_columns = 4
	screen_max_rows = 4

/datum/storage/concrete/vtm/firstaid/ifak
	screen_max_columns = 3
	screen_max_rows = 3

/obj/item/storage/backpack
	component_type = /datum/storage/concrete/vtm/backpack

/datum/storage/concrete/vtm/holster
	screen_max_columns = 2
	screen_max_rows = 2

/datum/storage/concrete/vtm/hardcase
	screen_max_columns = 4
	screen_max_rows = 4

/datum/storage/concrete/vtm/car
	screen_max_columns = 7
	screen_max_rows = 9

/datum/storage/concrete/vtm/car/track
	screen_max_columns = 12
	screen_max_rows = 12

/datum/storage/concrete/vtm/sheathe
	screen_max_columns = 2
	screen_max_rows = 5
